<cfoutput>
	<span class="image"> 
		<cfif node.data.keyExists('assetMeta')>
			...
			<img  align="center" style="max-width:100%" src="#pathToURL( "#book.getSourcePath()#resolvedAssets/#fileName#" )#" alt="#node.data?.caption ?: ''#" />
		<cfelseif node.data.keyExists( 'src' )>
			...
			<img  align="center" style="max-width:100%" src="#pathToURL( localpath )#" alt="#node.data?.caption ?: ''#" />
		</cfif>
	</span>
</cfoutput>