<cfoutput>
	<div class="image"> 
		<cfif node.data.keyExists('assetMeta')>
			...
			<img  align="center" style="max-width:100%" src="#pathToURL( "#book.getSourcePath()#resolvedAssets/#fileName#" )#" />
		<cfelseif node.data.keyExists( 'src' )>
			...
			<img  align="center" style="max-width:100%" src="#pathToURL( localpath )#" />
		</cfif>
